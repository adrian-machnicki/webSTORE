...
<nav class="col-md-2 d-none d-md-block bg-light sidebar">
	<div class="sidebar-sticky">
		...
		<ul class="nav flex-column">
			...
			<li class="nav-item">
         		<a class="nav-link <c:if test="${ adminTab == 'DASHBOARD' }">active</c:if>" href="/#">
			...
			<li class="nav-item">
				<a class="nav-link <c:if test="${ adminTab == 'ORDERS' }">active</c:if>" href="${request.contextPath}/admin/orders">
    				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
			...
			<li class="nav-item">
  				<a class="nav-link <c:if test="${ adminTab == 'BOOKS' }">active</c:if>" href="${request.contextPath}/admin/books">
    				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
			...
			<li class="nav-item">
  				<a class="nav-link <c:if test="${ adminTab == 'USERS' }">active</c:if>" href="${request.contextPath}/admin/users">
    				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
			...
			<li class="nav-item">
				<a class="nav-link <c:if test="${ adminTab == 'REPORTS' }">active</c:if>" href="/#">
    				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
    					stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bar-chart-2">
